              ...
              >
                {STATUS_OPTIONS.map(opt => (
                  <DropdownMenuItem
                    ...
                    className={`cursor-pointer mb-1 px-3 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-colors flex items-center gap-2 relative z-10 ${status === opt ? 'bg-zinc-900 text-white outline outline-1 outline-white/20 hover:bg-white hover:text-black' : 'text-gray-300'}`}
                  >
